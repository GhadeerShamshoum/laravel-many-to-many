      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="d-flex">
            ...
            <a class="m-2" href="{{route("admin.posts.edit", $post->id)}}">
              <button type="button" class="btn btn btn-info text-white p-2">
            ...
            <form action="{{route("admin.posts.destroy", $post->id)}}" method="POST">
                  @csrf
                  @method("DELETE")
                  <button type="submit" class="btn btn-danger m-2 p-2" onclick="return confirm('Are you sure wwant to delete this item?')">
